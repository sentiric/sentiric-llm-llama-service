...
chat_turn() {
    ...
    # [GÜNCELLEME] Regex 09:00 saatini de geçerli bir teyit sayar
...
# [GÜNCELLEME] Saat bilgisini de kabul et (Gemma Matrix run'da sadece saati dönebiliyor)
chat_turn "Yarın sabah işim var mı?" "toplantı|evet|09:00" "Yarın Kontrolü"
